...
class BootStatesTest : public ::testing::Test
{
public:
    MockQueue queue;
    MockArm mock_arm;
...
// testing
TEST_F(BootStatesTest, BootToIdle)
{
    IKioskState& currentState = BootState::getInstance();
    {
